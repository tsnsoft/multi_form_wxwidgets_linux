...
multi_form_wxwidgetsFrame::multi_form_wxwidgetsFrame(wxWindow* parent,wxWindowID id)
{
    ...
    TextCtrl1 = new wxTextCtrl(this, ID_TEXTCTRL1, wxEmptyString, wxPoint(184,16), wxDefaultSize, 0, wxDefaultValidator, _T("ID_TEXTCTRL1"));
    Center();
